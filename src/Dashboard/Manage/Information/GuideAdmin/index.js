...
class GuideAdmin extends Component {
    constructor(props) {
        super(props)
        this.state = {
            loading: true,
                ...
                <div class="block-body">
                    <div className="row">
                        <div className="col-lg-12">
                            <h3 className="font-m">Настройки пошговой инструкции</h3>
                            ...
                            <div className="form-group message-area">
                                <label for="advert" className="font-m">гайд</label>
                                <textarea name="guide" value={this.state.guide} onChange={this.handleChange} className="form-control" placeholder="Введите гайд" />
                            </div>
