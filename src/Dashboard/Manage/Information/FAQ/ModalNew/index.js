            ...
            <div>
                <Modal size="lg" isOpen={this.props.modal} toggle={() => { this.props.toggle(0) }}>
                    <div className="modal-header text-center">
                        <h4 className="modal-title font-m">Статья новая</h4>
                    </div>
                    <ModalBody>
                        <div className="row">
                            ...
                            <div class="form-group">
                                    ...
                                    <input className='form-control' value={this.state.name} placeholder="Введите название статьи" name="name" onChange={this.handleChange} />
                                </div>
                                <div class="form-group">
