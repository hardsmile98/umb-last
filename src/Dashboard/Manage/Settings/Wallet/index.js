                ...
                <div className='row'>
                    <div className='col-lg-6'>
                        <div class={"income font-m income-orange animate__animated animate__fadeIn " + (this.state.loading ? "blur" : "")}>
                            <h5><span>Баланс</span></h5><h2><span>{this.state.data.balances.mine.trusted} BTC /  {Math.round(this.state.data.balances.mine.trusted*this.state.data.settings['RUB'])} RUB /  {Math.round(this.state.data.balances.mine.trusted*this.state.data.settings['USD'])} USD </span></h2>
                        </div>
                    </div>
                    <div className='col-lg-6'>
                        <div class={"income font-m animate__animated animate__fadeIn " + (this.state.loading ? "blur" : "")}>
                            <h5><span>Ожидает подтверждения</span></h5><h2><span>{this.state.data.balances.mine.untrusted_pending} BTC /  {Math.round(this.state.data.balances.mine.untrusted_pending*this.state.data.settings['RUB'])} RUB /  {Math.round(this.state.data.balances.mine.untrusted_pending*this.state.data.settings['USD'])} USD </span></h2>
                        </div>
                    </div>
                                        ...
                                        <div className='row'>
                                            <div className='col-lg-6'>
                                                <div className='avatar-block font-m text-center'>
                                                    {this.state.data.settings['fee30min']} sat/vByte<br />
                                                    30 мин
                                                </div>
                                            </div>
                                            <div className='col-lg-6'>
                                                <div className='avatar-block font-m text-center'>
                                                    {this.state.data.settings['fee60min']} sat/vByte<br />
                                                    60 мин
                                                </div>
                                            </div>
