                ...
                <div class="block-body">
                    <div className="row">
                        <div className="col-lg-12">
                            <h3 className="font-m">{getLocales("Создание страницы")}</h3>
                            <div className='row'>
                                ...
                                <button className='btn btn-primary left font-m' onClick={this.sendData}>{getLocales("Создать страницу")}</button>
                                </div>
                                </div>
                            </div>
                        </div>
