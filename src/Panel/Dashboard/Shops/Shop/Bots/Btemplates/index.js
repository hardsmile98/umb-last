...
class Btemplates extends Component {
    constructor(props) {
        super(props)
        this.state = {
            loading: true,
            ...
            <>
                    ...
                    <div class="block-body">
                        <div className="row">
                            <div className="col-lg-12">
                                <h3 className="font-m">{global.getLocales('Шаблоны кнопок')}</h3>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                >
                    <div class="xtabs__body">
                        <a className={"xtabs__item font-m " + (this.state.category == "main" ? "active" : "")} onClick={() => { this.changeCategory("main") }}>
                ...
                <div className='row'>
                    <div className='col-lg-8 bigzindex'>
                        <div class={"block animate__animated animate__fadeIn margin-block-top " + (this.state.loading ? "blur" : "")}>
                            <div class="block-body">
                                <h3 className="font-m">{global.getLocales('Шаблон')}: {this.state.templateName} {this.state.canRecovery ? <span className='right'><a onClick={this.toggle}>Восстановить шаблон</a></span> : ''}</h3>
                                <div className='row'>
                                    <div className='col-lg-12'>
                                        <EmojiInput type="input" value={this.state.content} placeholder="Введите содержание страницы" name="content" handleChange={this.handleChange} />
                                        <br />
                                    </div>
