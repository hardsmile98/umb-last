...
class LangAdminShop extends Component {
    constructor(props) {
        super(props)
        this.state = {
            loading: true,
                ...
                <div class="block-body">
                    <div className="row">
                        <div className="col-lg-12">
                            <h3 className="font-m">Настройка LocalesShop</h3>
                       
                            <div className="form-group message-area">
                                <label for="advert" className="font-m">LocalesShop</label>
